    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.invoices.store") }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('registrar') ? 'is-invalid' : '' }}" type="text" name="registrar" id="registrar" value="{{ old('registrar', '') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('teacher') ? 'is-invalid' : '' }}" type="text" name="teacher" id="teacher" value="{{ old('teacher', '') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('total_hour') ? 'is-invalid' : '' }}" type="text" name="total_hour" id="total_hour" value="{{ old('total_hour', '') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('amount_fee') ? 'is-invalid' : '' }}" type="text" name="amount_fee" id="amount_fee" value="{{ old('amount_fee', '') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('date_class') ? 'is-invalid' : '' }}" type="text" name="date_class" id="date_class" value="{{ old('date_class', '') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('fee_perhour') ? 'is-invalid' : '' }}" type="text" name="fee_perhour" id="fee_perhour" value="{{ old('fee_perhour', '') }}">
