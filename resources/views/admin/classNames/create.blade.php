...
<div class="card">
    <div class="card-header">
        {{ trans('global.create') }} {{ trans('cruds.className.title_singular') }}
    </div>

    <div class="card-body">
        <form method="POST" action="{{ route("admin.class-names.store") }}" enctype="multipart/form-data">
            @csrf
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('feeperhour') ? 'is-invalid' : '' }}" type="number" name="feeperhour" id="feeperhour" value="{{ old('feeperhour', '') }}" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('allowanceperhour') ? 'is-invalid' : '' }}" type="number" name="allowanceperhour" id="allowanceperhour" value="{{ old('allowanceperhour', '') }}" required>
